...
class ParserManagerTest(unittest.TestCase):
    ...
    _win_evtx_event = {
        ...
        'store_index': 5610,
        'store_number': 56,
        'strings': ['S-1-0-0', '-', '-', '0x0000000000000000', 'S-1-5-7',
                    'ANONYMOUS LOGON', 'NT AUTHORITY', '0x0000000000094a1b',
                    '3', 'NtLmSsp ', 'NTLM', 'STUDENT-PC1',
                    '{00000000-0000-0000-0000-000000000000}', '-', 'NTLM V1',
